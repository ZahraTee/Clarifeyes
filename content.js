...
getToken(client_details);

function getToken(client_details)
{
	console.log("client id " + client_details[0]);
	console.log("client_secret " + client_details[1]);
	$.post("https://api.clarifai.com/v1/token/", {grant_type: "client_credentials", client_id: client_details[0], client_secret: client_details[1]}, function(result){
        token = result;
